 ...
 * @author example
 */
public class ListaMaterialItems {
...
//          String[] nombreComlumns = {"id", "idtela","idcorte", "uds", "nombrei", "nombret","nombrec", "tela", "hoja", "uds1", "total", "totalunidades"};
        ...
        udsColumn = new ColumnConfig("UDS", nombreComlumns[3], 100, false);
        detalleColumn = new ColumnConfig("Detalle", nombreComlumns[4], 200, false);
        totalColumn = new ColumnConfig("Total", nombreComlumns[5], 100, false);
        fechaColumn = new ColumnConfig("Fecha", nombreComlumns[6], 200, false);
...
//        precioBsColumn.setEditor(new GridEditor(num_field1));
        ...
        udsColumn.setEditor(new GridEditor(num_field1));
        ...
        grid.setTitle("Lista Material Items");
        grid.setStore(store);
