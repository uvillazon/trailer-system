 ...
 * @author Uvillazon
 */
public class ConsultaMateriaPrima extends FormPanel {
...
//    private consultas padre;
    ...
    public ConsultaMateriaPrima(Object[][] almacenMM1109) {
        // this.padre = padres;
...
//        setLabelWidth(100);
        ...
        setIconCls("tab-icon");
        setAutoScroll(false);
        setTitle("Cunsulta Materia Prima");
...
//        }
    ...
    void verReporteMovimientoProductos() {
        String enlace = "funcion=MovimientoProducto&" + getForm().getValues();
        if (print != null) {
            print.clear();
            print.destroy();
            print = null;
    ...
    private void initCombos() {
        ...
        com_producto.setEmptyText("Buscar Materia Prima");
