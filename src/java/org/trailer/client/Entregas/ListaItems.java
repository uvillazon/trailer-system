...
//          String[] nombreComlumns = {"id", "idtela","idcorte", "uds", "nombrei", "nombret","nombrec", "tela", "hoja", "uds1", "total", "totalunidades"};
        ...
        udsColumn = new ColumnConfig("UDS", nombreComlumns[2], 50, false);
        detalleColumn = new ColumnConfig("Detalle", nombreComlumns[3], 200, false);
        cantidadColumn = new ColumnConfig("Cantidad", nombreComlumns[4], 200, false);
        fechaColumn = new ColumnConfig("Fecha", nombreComlumns[5], 200, false);
        encargadoColumn = new ColumnConfig("Encargado", nombreComlumns[6], 100, false);
...
//        precioBsColumn.setEditor(new GridEditor(num_field1));
        ...
        grid.setTitle("Entrega de Items");
        grid.setStore(store);
