...
public class ListaCompraProducto {
    ...
    String[] nombreComlumns = {"id", "detalle", "unidad", "cantidad","preciounitario", "preciototal"};
    ...
    public void onModuleLoad() {
        ...
        detalleColumn = new ColumnConfig("Detalle", nombreComlumns[1], (ANCHO/3)+20, true, null, "detalle");
        cantidadColumn = new ColumnConfig("Cantidad", nombreComlumns[3],(ANCHO/7) , true);
        unidadColumn = new ColumnConfig("Unidad", nombreComlumns[2], (ANCHO/7)+20, true);
        punitColumn = new ColumnConfig("P/Unit.", nombreComlumns[4], (ANCHO/7), true);
        totalColumn = new ColumnConfig("Total", nombreComlumns[5], (ANCHO/7), true);
        ...
        detalleProducto.addListener(new ButtonListenerAdapter() {
            ...
            public void onClick(Button button, EventObject e) {
                ...
                if (records.length == 1) {
                    selecionado = records[0].getAsString("id");
                    grid.stopEditing();
                    MessageBox.alert("aqui debe entrar el reporte o detalle del producto"+selecionado);
