 ...
 * @author example
 */
public class ListaProductosProceso {
...
//    private ColumnConfig totalColumn;
    ...
    String[] nombreComlumns = {"id","cantidad","unidad","detalle"};
    private RecordDef recordDef;

    public void onModuleLoad(String titulo) {
        panel = new Panel();
        ...
        idColumn = new ColumnConfig("Id Producto", nombreComlumns[0], 20, false);
        cantidadColumn = new ColumnConfig("Cantidad", nombreComlumns[1],80 , false);
        unidadColumn = new ColumnConfig("Unidad", nombreComlumns[2],70 , false);
        detalleColumn = new ColumnConfig("Detalle", nombreComlumns[3], 310, false, null, "detalle");
