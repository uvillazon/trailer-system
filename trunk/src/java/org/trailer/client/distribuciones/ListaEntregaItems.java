 ...
 * @author example
 */
public class ListaEntregaItems {
    ...
    String[] nombreComlumns = {"id", "iditems", "cantidad", "detalle", "fecha"};
...
//          String[] nombreComlumns = {"id", "idtela","idcorte", "uds", "nombrei", "nombret","nombrec", "tela", "hoja", "uds1", "total", "totalunidades"};
        ...
        cantidadColumn = new ColumnConfig("UDS", nombreComlumns[2], 100, false);
        detalleColumn = new ColumnConfig("Detalle", nombreComlumns[3], 250, false);
        fechaColumn = new ColumnConfig("Fecha", nombreComlumns[4], 200, false);
...
//        precioBsColumn.setEditor(new GridEditor(num_field1));
        ...
        grid.setTitle("Lista de Entregas Por Items");
        grid.setStore(store);
